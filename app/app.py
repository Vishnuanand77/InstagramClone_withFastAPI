...
from app.db import create_db_and_tables, Post, get_async_session, User
...
async def upload_file(
    ...
    user: User = Depends(current_active_user), # Dependency injection: Receive a user object from the dependency graph
